        ...
        <DashboardLayout activeMenu="Subscription">
            <div className="p-6">
                            ...
                            <button
                                ...
                                className={`w-full py-2 rounded-md font-medium transition-colors ${
                                    plan.recommended
                                        ...
                                        : 'bg-white border border-blue-500 text-blue-500 hover:bg-purple-50'
                ...
                <div className="mt-8 bg-gray-50 p-4 rounded-lg border border-gray-200">
                    ...
                    <p className="text-sm text-gray-600 mt-2">
                        <strong>File size limit:</strong> Maximum 5MB per file. At once you can upload 5 files as long as you they are under 25MB in total.
                    </p>
                </div>
