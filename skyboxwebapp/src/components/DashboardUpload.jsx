        ...
        <div className="w-full">
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                    <ArrowUpFromLine className="text-blue-500-500" size={18} />
            ...
            <div
                className="border-dashed border-2 border-gray-300 rounded-lg p-6 text-center bg-white cursor-pointer hover:border-blue-500-500 transition-colors"
            ...
            {files.length > 0 && (
                <div className="mt-3">
                    <button
                        ...
                        className="w-full py-2 bg-blue-500 text-white text-sm rounded-md hover:bg-blue-600 disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
                    >
                        {uploading ? (
                            <>
