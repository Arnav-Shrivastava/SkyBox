            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="text-center">
                    ...
                    <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-500">
                        SkyBox is a secure digital vault that offers effortless collaboration, intuitive organization, and seamless syncing, all while giving you granular control over your files.
                    </p>
                </div>
                <div className="mt-16">
